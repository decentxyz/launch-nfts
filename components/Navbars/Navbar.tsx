  ...
  return (
    <>
      <nav className={`${styles.navbar} w-full flex flex-wrap items-center sm:justify-between justify-center`} >
        ...
        <div className="hidden sm:flex items-center w-1/5">
          {DecentIcon("34", "34")} <a href="https://checkout.decent.xyz/" target="_blank" className="px-4 text-xl font-medium hover:text-primary">Onramp</a> <span className="text-2xl pt-[2px]"> ⬛</span>
        </div>
